...
class LevelEventPacket extends DataPacket{
	...
	const EVENT_SOUND_ITEM_DROP = 1030;
	const EVENT_SOUND_ITEM_THROWN = 1031;

	const EVENT_SOUND_ITEM_FRAME_ITEM_ADDED = 1040;
	const EVENT_SOUND_ITEM_FRAME_PLACED = 1041;
	const EVENT_SOUND_ITEM_FRAME_REMOVED = 1042;
	const EVENT_SOUND_ITEM_FRAME_ITEM_REMOVED = 1043;
	const EVENT_SOUND_ITEM_FRAME_ITEM_ROTATED = 1044;
